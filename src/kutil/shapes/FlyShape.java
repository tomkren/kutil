...
/**
 * Tvar KObjectu Fly.
 * Vykresluje se moucha, její cíl a Kispová reprezentace její paměti.
 * @author Tomáš Křen
 */
public class FlyShape extends AnimationShape {

    private Fly fly;

    public FlyShape( Fly fly ) {
        super( Global.shapeFactory().flyImgs,
               Global.shapeFactory().flyImgSel,
