...
/**
 * Tvar zadaný body konvexního polygonu a obrázkem.
 * @author sekol
 */
public class ImageShape extends ConvexPolygonShape {
    ...
    public ImageShape( BufferedImage image, BufferedImage imageSelected, 
